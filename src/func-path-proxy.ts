type Properties<T> = {
  [name: string]: T & Properties<T>;
  [index: number]: T & Properties<T>;
};

type FunctionProxy<T extends Function> = T & Properties<T & Properties<T & Properties<T
  & Properties<T & Properties<T & Properties<T & Properties<T & Properties<T & Properties<T
  & Properties<T & Properties<T & Properties<T & Properties<T & Properties<T & Properties<T
  & Properties<T & Properties<T & Properties<T & Properties<T>>>>>>>>>>>>>>>>>>>;
